(function ($) {
    $.fn.extend({
        searchMeme: function (options) {
            ...
            var settings = $.extend({ animationSpeed: 500, defaultText: 'Search City...', button: 'orange', buttonPlacement: 'left', onSearch: null, searchComplete: false }, options);
            ...
            return this.each(function () {
                ...
                searchBox.on("change keyup keypress",(function (e) {
                    if (e.which == 13) {
                        triggerSearch();
                    }
                }))
